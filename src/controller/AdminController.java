...
public class AdminController implements Initializable { 
	...
	/**
	 * This method initializes the controllers data variables after its root element is complete.
	 */
	 ...
	 * This method catches the user's click event to create a new user and creates a new dialog for the user. 
	 */
	
	@FXML private void createNewUserAction(ActionEvent event) throws ClassNotFoundException {
	    	GridPane gridPane;
	 ...
	 * @param event ActionEvent
	 * @throws ClassNotFoundException
	 * This method catches the user's click event to remove a new user and removes the selected user from the listOfAllUsers. 
	 */
	
	@FXML private void removeUserAction(ActionEvent event) throws ClassNotFoundException, IOException {
	...
	@FXML private void loggingOut(ActionEvent event) throws IOException, ClassNotFoundException {
	...
	/**
	 * @param stage Stage
	 * sets the Admin's controller stage to the stage param.
	 */ 
